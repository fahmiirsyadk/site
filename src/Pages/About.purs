...
view =
  H.div [ H.classes [ "space-y-5" ] ]
    [ H.h1 [ H.classes [ "text-[12px]", "leading-[1.7]", "font-semibold", "text-[#171717]", "dark:text-neutral-100" ] ] [ H.text "About" ]
    , H.p [ H.classes [ "text-[12px]", "leading-[1.7]", "text-neutral-600", "dark:text-neutral-400" ] ]
