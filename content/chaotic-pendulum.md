...
date: "2026-06-22T06:30:00+07:00"
slug: chaotic-pendulum
section: thought
banner: "/assets/banners/pendulum.png"
status: published
tags: ["life", "thought"]
ogTitle: "Chaotic Pendulum: Compassion, Judgment, and the Room That Won't Sit Still"
ogDescription: "Thought on the swing between self-compassion and self-judgment - the room we swing in keeps moving, and what actually shortens the arc."
ogImage: "/assets/banners/pendulum.png"
---
...
![pendulum-explained](/assets/images/chaotic-pendulum/pendulum-detail.webp)
...
The psychoanalyst Karen Horney had her own name for something close to this. In *Neurosis and Human Growth*, she described a self split in two: an idealized self sweet, infallible, endlessly productive and a despised self, the one that surfaces every time the idealized version isn't met. She called the inner demands enforcing that split **"the tyranny of the should."**[^horney] And she pictured the person caught inside it swinging the way a pendulum does between a perfection that was *never real* to begin with, and a self-hatred that feels *all too real*.

![power](/assets/images/wp2.webp)
...
Albert Camus, writing about a man condemned to push a boulder up a hill forever only to watch it roll back down, refused to end the story in despair. **"The struggle itself toward the heights is enough to fill a man's heart."**[^camus] Not the arrival. Not the rock staying put at the top. The struggle itself.
...
[^zeno]: Zeno of Elea's arrow paradox, preserved in Aristotle, *Physics* VI:9 (239b5–30). See ["Zeno's paradoxes."](https://en.wikipedia.org/wiki/Zeno%27s_paradoxes)

[^horney]: Karen Horney, *Neurosis and Human Growth: The Struggle Toward Self-Realization* (New York: W. W. Norton, 1950) — the chapter "The Tyranny of the Should."

[^kafka]: Franz Kafka, "A Hunger Artist" (*Ein Hungerkünstler*, 1922). See ["A Hunger Artist."](https://en.wikipedia.org/wiki/A_Hunger_Artist)

[^huygens]: Christiaan Huygens described this "odd sympathy" of two pendulum clocks sharing a beam in February 1665. See ["Odd sympathy."](https://en.wikipedia.org/wiki/Odd_sympathy)

[^huygens-modern]: The experiment was reconstructed and analysed in M. Bennett, M. F. Schatz, H. Rockwood & K. Wiesenfeld, "Huygens's clocks," *Proceedings of the Royal Society A* 458 (2002): 563–579.

[^yerkes]: Robert M. Yerkes & John D. Dodson, "The relation of strength of stimulus to rapidity of habit-formation," *Journal of Comparative Neurology and Psychology* 18 (1908): 459–482. See ["Yerkes–Dodson law."](https://en.wikipedia.org/wiki/Yerkes%E2%80%93Dodson_law)

[^neff]: Kristin Neff, *Fierce Self-Compassion: How to Harness Kindness to Speak Up, Claim Your Power, and Thrive* (New York: Harper Wave, 2021). More at [self-compassion.org](https://self-compassion.org).

[^camus]: Albert Camus, *The Myth of Sisyphus* (*Le Mythe de Sisyphe*, 1942), closing lines. See ["The Myth of Sisyphus."](https://en.wikipedia.org/wiki/The_Myth_of_Sisyphus)
